...
class AgentEngine:
    ...
    def reload_model(self):
        ...
        generation_config = {
            ...
            # "thinking_budget": 1024  # Sẵn sàng cho tính năng Deep Think (khi API hỗ trợ public)
        }

        self.model = genai.GenerativeModel(
            model_name="gemini-2.0-flash-exp", # Sử dụng model mới nhất
